...
% ====================== YOUR CODE HERE ======================
% Instructions: Fill in this function to return the optimal C an:;sigma
...
% find C and sigma with minimum error

[r,c]=find(error_i==min(min(error_i)));

% Columns of error_i stand for d/t values of C
% Rows stand for d/t values of sigma
